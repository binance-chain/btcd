...
* Download the Conformal public key:
  https://raw.githubusercontent.com/binance-chain/btcd/master/release/GIT-GPG-KEY-conformal.txt
...
* Install the MSI available at: [btcd windows installer](https://github.com/binance-chain/btcd/releases)
...
```bash
git clone https://github.com/binance-chain/btcd $GOPATH/src/github.com/binance-chain/btcd
...
* [Using bootstrap.dat](https://github.com/binance-chain/btcd/blob/master/docs/configuration.md#using-bootstrapdat)
