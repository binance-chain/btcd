...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/binance-chain/btcd/chaincfg/chainhash)
=======
...
```bash
$ go get -u github.com/binance-chain/btcd/chaincfg/chainhash
```
